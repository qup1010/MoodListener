...
export const Settings: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const savedTheme = localStorage.getItem('themeId') || 'forest';
  ...
  const rowClassName = 'flex items-center justify-between p-4 transition-colors cursor-pointer active:bg-black/3 dark:active:bg-white/6';
        ...
        <section>
          ...
          <div className="ui-card overflow-hidden">
            ...
            <div className="border-b border-[var(--ui-border-subtle-light)] dark:border-[var(--ui-border-subtle-dark)]">
              <button className={`${rowClassName} w-full`} onClick={() => setShowDarkModePicker(!showDarkModePicker)}>
                <div className="flex items-center gap-3">
            ...
            <div>
              <button className={`${rowClassName} w-full`} onClick={() => setShowThemePicker(!showThemePicker)}>
                <div className="flex items-center gap-3">
